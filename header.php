			...
			<div class="dlstrs-shadowheader">
				<div class="dlstrs-container-header">
					...
					<nav class="dlstrs-site-navigation main-navigation">
						<button class="dlstrs-assistive-text"><?php _e( 'Menu', 'dlstrs' ); ?></button><!--.dlstrs-assistive-text-->
						<div class="dlstrs-assistive-text skip-link">
							<a href="#content" title="<?php esc_attr_e( 'Skip to content', 'dlstrs' ); ?>"><?php _e( 'Skip to content', 'dlstrs' ); ?></a>
