		...
		<?php if ( have_posts() ) { 
			while ( have_posts() ) { 
				...
				<div id="post-<?php the_ID(); ?>" <?php post_class( 'dlstrs-post' ); ?>>
					...
					<?php edit_post_link( __( 'Edit', 'dlstrs' ), '<div class="dlstrs-edit-link">', '</div>' );
			...
			<div class="dlstrs-navigation">
				<div class="dlstrs-older-posts">
					<?php next_posts_link( __( 'Previous posts', 'dlstrs' ) ); ?>
				</div><!-- .dlstrs-older-posts -->
				<div class="dlstrs-newer-posts">
					<?php previous_posts_link( __( 'Next posts', 'dlstrs' ) ); ?>
